 ...
 */
public class RideNewFragment extends Fragment implements OnMapReadyCallback {
    ...
    public void storeCoordinatesForDistance() {
        ...
        rDist = new Runnable() {
            ...
            public void run() {
                ...
                hDist.postDelayed(rDist, 30000);//5 min ~ 300 sec //changed to 1 min ~ 60 sec ~ 30 sec
                ...
                if (current_lat != 0.0 && current_long != 0.0) {
                    ...
                    dbAdapter.insertEntry(stDSNo, current_lat, current_long, complete_address, resDist, timeUpdated);
                    dbAdapter.insertLatLngEntry(stDSNo,current_lat,current_long,"");
                            ...
                            public void onResponse(Call<DistancePojo> call, Response<DistancePojo> response) {
                                ...
                                if (response.isSuccessful()) {
                                    ...
                                    if (rDataList != null) {
                                        ...
                                        b.putString("stBeforePickUp", stBeforePickUp);
                                        b.putString("stAfterPickUp", stAfterPickUp);
                                        b.putString("stAfterDrop", stAfterDrop+" snapToRoadWaypoints: "+snapToRoadWaypoints+"@approx.addedDist:"+approxFinalDist+"@DistanceAlgo(m):"+res);
                                        b.putString("sign", signature);
                                        b.putFloat("startToReportKms",startToReportKms);
                                        b.putFloat("startToReportHrs",startToReportHrs);
                                        b.putFloat("finishToGarageKms",finishToGarageKms);
        ...
        call.enqueue(new Callback<SnapDistance>() {
            ...
            public void onResponse(Call<SnapDistance> call, Response<SnapDistance> response) {
                ...
                if(response.isSuccessful())
                {
                    ...
                    //System.out.println(" k size isss"+k);
                    ...
                    //System.out.println("flagForFinishClicked isssss"+flagForFinishClicked);
                    //System.out.println("Waypoints areeeeeeeeeeee"+stWaypoints);

                    if(flagForFinishClicked)
                    {
                        //System.out.println("from lat beforr"+crntPickupLat);
                        crntPickupLat=pref.getString("from_lat",crntPickupLat);
                        crntPickupLng=pref.getString("from_lng",crntPickupLng);
                        //System.out.println("from lat after"+crntPickupLat);
