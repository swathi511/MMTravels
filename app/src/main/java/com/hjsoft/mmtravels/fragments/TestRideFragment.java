                            ...
                            */
                            ...
                            if (!(pickupLat.equals("")) || !(pickupLong.equals(""))) {
                                ...
                                if (!(dropLat.equals("0.0")) || !(dropLong.equals("0.0"))) {
                                    ...
                                    // from here actual code starts...

                                    flagForFinishClicked=true;

                                    //System.out.println("Waypoints count till nowww.."+dbAdapter.getWaypointsCount(stDSNo));

                                    getWaypointsTillNow(dbAdapter.getWaypointsForSnapToRoad(stDSNo));
                                    //getWaypointsTillNow("17.4183,78.544|17.4182,78.5442|17.4183,78.5443|17.4158,78.5453|17.4116,78.5499|17.4072,78.5546|17.4051,78.5564|17.4024,78.5593|17.3999,78.5602|17.3942,78.5592|17.3887,78.5588|17.3825,78.5585|17.378,78.5579|17.3829,78.5584|17.3889,78.5586|17.3949,78.559|17.3992,78.5603|17.4028,78.5592|17.4051,78.5563|17.4078,78.5541|17.4124,78.5493|17.4154,78.5455|17.4187,78.5417|17.421,78.5398|17.4213,78.5395|17.4194,78.5412|17.4181,78.5427|17.4175,78.5433");
                ...
                if (lastLocDist != null && current_lat != 0.0 && current_long != 0.0 )
                {
                    ...
                    if(marker!=null){
                        ...
                        marker = mMap.addMarker(new MarkerOptions().position(curntloc)
                                ...
                                .icon(BitmapDescriptorFactory.fromResource(R.drawable.cab_new)));
                    }
...
//                    mMap.animateCamera(CameraUpdateFactory.newCameraPosition(pos));
                    ...
                    //System.out.println("RESULT ISS"+results[0]);

                    if(results!=null) {
                        res = res + results[0];
                    }

                    //System.out.println("FINAL RESULT ISS"+res);
    ...
    public void storeCoordinatesForDistance() {
        ...
        rDist = new Runnable() {
            ...
            public void run() {
                ...
                hDist.postDelayed(rDist, 60000);//5 min ~ 300 sec //changed to 1 min ~ 60 sec ~ 30 sec
               ...
               /* System.out.println("Temp values are...");
                ...
                if (tempLat != 0.0 && tempLong != 0.0) {
                    ...
                    if (first) {
                        ...
                        editor.putString("from_lat",pickupLat);
                        editor.putString("from_lng",pickupLong);
                        editor.commit();
                        ...
                        //System.out.println("Kalman lat lng"+kalmanLatLong.get_lat()+":::"+kalmanLatLong.get_lng());
                            ...
                            if (iteration == 4) {
                                ...
                                call1.enqueue(new Callback<Pojo>() {
                                    ...
                                    public void onFailure(Call<Pojo> call, Throwable t) {
                                        ...
                                        Toast.makeText(getActivity(), "Issue in Internet connection!", Toast.LENGTH_LONG).show();
    ...
    public void sendTripDetails()
    {
        JsonObject v=new JsonObject();
        v.addProperty("dslipid",stDSNo);
        v.addProperty("tripdetails","");
        v.addProperty("distancepoints","");
        v.addProperty("Totalkms","");

        Call<Pojo> call=REST_CLIENT.sendDistanceForInterval(v);
        call.enqueue(new Callback<Pojo>() {
            @Override
            public void onResponse(Call<Pojo> call, Response<Pojo> response) {
