 ...
 */
public class RideNewOngoingFragment extends Fragment implements OnMapReadyCallback {
                                        ...
                                        public void onResponse(Call<DistancePojo> call, Response<DistancePojo> response) {
                                            ...
                                            if (response.isSuccessful()) {
                                                ...
                                                if (rDataList != null) {
                                                    ...
                                                    //finalDistance=Float.parseFloat("8.3");
    ...
    public void storeCoordinatesForDistance()
    {
        ...
        rDist=new Runnable() {
            ...
            public void run() {
                ...
                hDist.postDelayed(rDist,30000);//5 min ~ 300 sec //changed to 1 min ~ 60 sec
